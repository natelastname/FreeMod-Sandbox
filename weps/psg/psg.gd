...
onready var anim_player = $"v_psg1/AnimationPlayer"
onready var bullethole = preload("res://particle/impact_dust.tscn")
var fire_audio_stream = preload("res://weps/psg/psg1fire.wav")
...
func swep_process(_delta):
	...
	if Input.is_action_just_pressed("wep_fire") and ammo > 0:
		ammo = ammo - 1
		anim_player.play("psg.003",-1,1)
